...
{
    [Area("Admin")]
    [Route("Admin/AdminBanner")] //Bu controller üzerinde tanımlanan metotların tamamı bu url'i alarak gidecek.
    public class AdminBannerController : Controller
    {
        ...
        public async Task<IActionResult> CreateBanner(CreateBannerDto createBannerDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7286/api/Banners", content);
            if (responseMessage.IsSuccessStatusCode)
            {
